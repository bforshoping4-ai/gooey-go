...
const AuthPage = () => {
  ...
  console.log("[AuthPage] Render, isLogin:", isLogin, "user:", user?.email);
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("[AuthPage] Email auth submit, mode:", isLogin ? "login" : "signup");
    ...
    try {
      if (isLogin) {
        ...
        console.log("[AuthPage] Signup successful, check email");
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.log("[AuthPage] Redirecting to Google...", data?.url);
        ...
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin ? "Sign in to manage your links" : "Sign up to start shortening links"}
            </p>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <button
              type="button"
              onClick={() => {
                console.log("[AuthPage] Toggling mode to:", !isLogin ? "login" : "signup");
                setIsLogin(!isLogin);
              }}
